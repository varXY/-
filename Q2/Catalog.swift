...
enum Unit {
	...
	var unitSubtitles: [String] {
		switch self {
		case .index(0, 0):
			return ["电势不同产生的能量差", "通过导体横截面的电量", "导体对电流阻碍作用的大小", "给定电位差下的电荷储藏量", "磁感应强度与面积的乘积", "单位时间内周期性变化的次数"]
		case .index(0, 1):
...
enum titlesInSection {
	...
	var titles: [String] {
		...
		case .index(2, 1):
			return ["发电机"]
		case .index(2, 2):
			return ["电源", "电容器", "空开", "变压器", "逆变器", "整流器", "继电器", "镇流器", "电瓶", "UPS"]
		case .index(2, 3):
